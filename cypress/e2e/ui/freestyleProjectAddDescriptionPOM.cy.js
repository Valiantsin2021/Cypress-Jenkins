...
describe('US_01.001 | FreestyleProject > Add description', () => {
  ...
  it('TC_01.001.01 | Add a description when creating a project', () => {
    ...
    freestyleProjectPage.getJobDescription().should('be.visible').and('have.text', project.description)
  })
  ...
  it('TC_01.001.02 | Add a Description to an Existing Project', () => {
    ...
    freestyleProjectPage.clickAddDescriptionButton().typeJobDescription(project.description).clickSaveButton()
  ...
  it('TC_01.001.03 | Verify updating an existing description', () => {
    ...
    freestyleProjectPage.getJobDescription().should('be.visible').and('have.text', project.newDescription)
  })
  ...
  it('TC_01.001.07 | It is possible to add description on project update', () => {
    ...
    freestyleProjectPage.typeJobDescription(project.newDescription).clickSaveButton()
