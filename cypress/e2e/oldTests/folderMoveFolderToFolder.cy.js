...
describe.skip('US_04.002|Folder > Move Folder to Folder', () => {
  it('TC_04.002-01A |Folder > Move Folder to Folder', () => {
    ...
    cy.get(
      '#j-add-item-type-nested-projects .j-item-options li[class*="folder_Folder"]'
    ).click()
    ...
    cy.get(
      `a[href="job/${folder2Name}/"] .jenkins-menu-dropdown-chevron`
    ).click()
    ...
    cy.get('li:nth-child(5) a').should(
      'have.attr',
      'href',
      `/job/${folder1Name}/job/${folder2Name}/`
    )
  })
})
