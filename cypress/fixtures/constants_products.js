export const constants = {
  ...
  header: 'All Products',
  sideHeaderCategory: 'Category',
  sideHeaderBrands: 'Brands',
  ...
  womenCategories: ['Dress', 'Tops', 'Saree'],
  menCategories: ['Tshirts', 'Jeans'],
  kidsCategories: ['Dress', 'Tops & Shirts '],
  productsOverlayHeader: [
    'Rs. 500',
    'Rs. 400',
    'Rs. 1000',
    'Rs. 1500',
